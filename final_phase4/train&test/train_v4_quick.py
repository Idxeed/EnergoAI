"""
Быстрое обучение EnergoAI v4 на Tiny Shakespeare (~150 шагов)
...
# !!! Если файл модели v4 лежит в другом месте или называется иначе — поправь импорт !!!
...
def train():
    ...
    print("\n" + "=" * 60)
    print("🚀 НАЧИНАЕМ ОБУЧЕНИЕ v4 (долговременная память)")
    print("=" * 60)
...
def plot_training_metrics(metrics):
    ...
    # 6. H Depth Norm (после RMSNorm) — теперь без фиксированного потолка
    ...
    plt.suptitle("EnergoAI v4 Training Metrics (150 steps)", fontsize=14, fontweight='bold')
    plt.tight_layout()
    plt.savefig("training_metrics_v4.png", dpi=150)
    print("📈 Графики сохранены в training_metrics_v4.png")
    plt.show()
